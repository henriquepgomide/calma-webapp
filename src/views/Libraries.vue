	...
	<div class="container">
	  <b-table 
	     ...
	     <template slot-scope="props">
	       <b-table-column field="material_name" label="Nome do material" width="600" searchable>
	    ...
	    <b-table-column field="language" label="Idioma">
		 ...
		 <div class="media-content">
		   <div class="content">
		     ...
		     <br>
		     <strong>Público alvo: </strong>{{ props.row.target_audience }}
		     <br>
		     </p>
		     <strong>Link: </strong>
		     <div v-if="props.row.original_link !== null">
		       <a :href="props.row.original_link">{{props.row.original_link}}</a>
		     </div>
		   </div>
		 </div>
	       </article>
